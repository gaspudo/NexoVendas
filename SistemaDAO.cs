    ...
    public void ConsultarProdutos()
    {
        ...
        public int IniciarVenda(int idCliente)
        {
            ...
            using (var conexao = _conexaoBanco.ObterConexao())
            {
                ...
                string query = "INSERT INTO tb_vendas (fk_cliente) VALUES (@idC); SELECT LAST_INSERT_ID();";
        ...
        public double AdicionarItemVenda(int idVenda, int idProduto, int quantidade)
        {
            ...
            using (var conexao = _conexaoBanco.ObterConexao())
            {
                ...
                string queryItem = "INSERT INTO tb_itens_venda (fk_vendas, fk_produto, qt_produto, vl_subtotal) VALUES (@idV, @idP, @qtd, @sub)";
        ...
        public double RemoverItemVenda(int idVenda, int idProduto)
        {
            ...
            using (var conexao = _conexaoBanco.ObterConexao())
            {
                ...
                string queryBusca = "SELECT cd_item, vl_subtotal FROM tb_itens_venda WHERE fk_vendas = @idV AND fk_produto = @idP ORDER BY cd_item DESC LIMIT 1";
                ...
                if (idItem > 0)
                {
                    ...
                    string queryDelete = "DELETE FROM tb_vendas WHERE cd_item = @idItem";
        ...
        public void FinalizarVenda(int idVenda, double valorTotal)
        {
            ...
            using (var conexao = _conexaoBanco.ObterConexao())
            {
                ...
                string query = "UPDATE tb_itens_venda SET vl_total_venda = @total WHERE cd_venda = @idV";
        ...
        public void GerarRelatorioCSV()
        {
            ...
            using (var conexao = _conexaoBanco.ObterConexao())
            {
                ...
                string query = @"
                    ...
                    INNER JOIN tb_itens_venda i ON v.cd_venda = i.fk_vendas
